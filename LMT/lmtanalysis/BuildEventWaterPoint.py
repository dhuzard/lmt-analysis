...
from lmtanalysis.Measure import MAX_DISTANCE_TO_POINT
...
def reBuildEvent(connection, file, tmin=None, tmax=None, pool=None):
    ...
    ''' Event Water Zone: the animal is in the zone around the water source '''
    ...
    for idAnimalA in pool.animalDictionnary.keys():
        ...
        for t in dicA.keys():
            if dicA[t].getDistanceToPoint(xPoint=398, yPoint=353) is None:
                continue
