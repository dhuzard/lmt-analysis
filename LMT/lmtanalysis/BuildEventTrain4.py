...
def reBuildEvent(connection, file, tmin=None, tmax=None, pool=None):
    ...
    '''
    Four animals are following each others with nose-to-anogenital contacts.
    The 4 animals are moving.
            ...
            for idAnimalC in range(1, pool.getNbAnimals() + 1):
                for idAnimalD in range(1, pool.getNbAnimals() + 1):
                    if (idAnimalA, idAnimalB, idAnimalC, idAnimalD) in train4:
                        trainTimeLine = EventTimeLine(None, "Train4", idAnimalA, idAnimalB, idAnimalC, idAnimalD,
                                                      loadEvent=False)
