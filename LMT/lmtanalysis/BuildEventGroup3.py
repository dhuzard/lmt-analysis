    ...
    for idAnimalA in range(1, 5):
        for idAnimalB in range(1, 5):
            if idAnimalA == idAnimalB:
                continue
            contact[idAnimalA, idAnimalB] = EventTimeLineCached(connection, file, "Contact", idAnimalA, idAnimalB,
        ...
        for idAnimalB in range(1, 5):
            ...
            for idAnimalC in range(1, 5):
                ...
                for idAnimalD in range(1, 5):
                    ...
                    groupTimeLine = EventTimeLine(None, eventName, idAnimalA, idAnimalB, idAnimalC, None,
                                                  loadEvent=False)
