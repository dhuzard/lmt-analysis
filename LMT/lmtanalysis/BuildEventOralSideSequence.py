...
def reBuildEvent(connection, file, tmin=None, tmax=None, pool=None):
    ...
    for idAnimalB in pool.animalDictionnary.keys():
        ...
        for idAnimalA in pool.animalDictionnary.keys():
            ...
            '''
            oralOral[idAnimalA, idAnimalB] = EventTimeLineCached(connection, file, "Oral-oral Contact", idAnimalA,
                                                                 idAnimalB, minFrame=tmin, maxFrame=tmax)
            oralGenital[idAnimalA, idAnimalB] = EventTimeLineCached(connection, file, "Oral-genital Contact", idAnimalA,
                                                                    idAnimalB, minFrame=tmin, maxFrame=tmax)
    ...
    '''    
    oral-oral followed by oral-genital
    '''
    ...
    print("Rebuild Oral-Genital Sequences event finished.")
