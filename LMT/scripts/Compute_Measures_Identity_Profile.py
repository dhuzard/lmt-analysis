...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        if behaviouralEventTwoMice is not None:
            for behavEvent in behaviouralEventTwoMice:
                ...
                for idAnimalA in pool.animalDictionnary:
                    ...
                    nbEventsSameGeno = getNumberOfEventWithList(connection, behavEvent, idAnimalA, animalSameGeno,
                                                                minFrame=tmin, maxFrame=tmax)
                    durEventsSameGeno = getDurationOfEventWithList(connection, behavEvent, idAnimalA, animalSameGeno,
                                                                   minFrame=tmin, maxFrame=tmax)
