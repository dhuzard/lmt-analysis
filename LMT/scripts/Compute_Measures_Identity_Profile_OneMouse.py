...
if __name__ == '__main__':
    ...
    behaviouralEventOneMouse = ["Contact", "Oral-oral Contact", "Oral-genital Contact", "Side by side Contact",
                                ...
                                "Approach contact", "Approach rear", "Break contact", "FollowZone Isolated",
                                "Train2", "Group2", "Group3", "Group 3 break", "Group 3 make", "Group4",
                                "Group 4 break", "Group 4 make", "Huddling", "Move isolated", "Move in contact",
    ...
    for file in files:
        ...
        for idAnimalA in pool.animalDictionnary.keys():
            ...
            for behavEvent in behaviouralEventOneMouse:
                ...
                behavEventTimeLine = EventTimeLineCached(connection, file, behavEvent, idAnimalA, minFrame=tmin,
                                                         maxFrame=tmax)
