...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        print("Number of frames recorded:  {} frames ({} seconds or {} minutes or {} hours or {} days)".format(
            nbFramesRecorded, nbFramesRecorded / oneSecond, nbFramesRecorded / oneMinute, nbFramesRecorded / oneHour,
            nbFramesRecorded / oneDay))
        text_file.write(
            "Number of frames recorded:  {} frames ({} seconds or {} minutes or {} hours or {} days)\n".format(
        ...
        for animal in pool.animalDictionnary.keys():
            ...
            print("Animal {}: {} missed detections over {} frames recorded ({} %)".format(
                pool.animalDictionnary[animal].RFID, nbFramesRecorded - nbOfDetections, nbFramesRecorded,
                missedDetection * 100))
        ...
        for animal in pool.animalDictionnary.keys():
            ...
            print("Number of RFID match for animal {}: {} (rate: {} events/min)".format(
