...
if __name__ == '__main__':
    ...
    behaviouralEventOneMouse = ["Contact", "Oral-oral Contact", "Oral-genital Contact", "Side by side Contact",
                                "Side by side Contact, opposite way", "Social approach", "Social escape", "Get away",
                                "Approach contact", "Approach rear", "Break contact", "FollowZone Isolated", "Train2",
                                "Group2", "Group3", "Group 3 break", "Group 3 make", "Group4", "Group 4 break",
                                "Group 4 make", "Huddling", "Move isolated", "Move in contact", "Nest3", "Nest4",
        ...
        for eventNight in nightEventTimeLine.getEventList():
            ...
            for idAnimalA in pool.animalDictionnary.keys():
                ...
                for behavEvent in behaviouralEventOneMouse:
                    ...
                    behavEventTimeLine = EventTimeLineCached(connection, file, behavEvent, idAnimalA, minFrame=minT,
                                                             maxFrame=maxT)
