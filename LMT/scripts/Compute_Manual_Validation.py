    ...
    for file in files:
        ...
        for behavEvent in behaviouralEvents:
            ...
            for idAnimalA in range(1, pool.getNbAnimals() + 1):
                ...
                print(event.eventName, genoA, event.idA, tmin, tmax, totalEventDuration, meanEventDuration,
                      maxEventDuration, minEventDuration)

                res = [file, event.eventName, event.idA, genoA, tmin, tmax, totalEventDuration, meanEventDuration,
                       maxEventDuration, minEventDuration]
                text_file.write("{}\n".format(res))
