...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        for idAnimalA in pool.animalDictionnary.keys():
            ...
            animalMakeGroupDictionary[idAnimalA] = EventTimeLine(connection, "Group 3 make", idAnimalA, minFrame=tmin,
                                                                 maxFrame=tmax)
            animalBreakGroupDictionary[idAnimalA] = EventTimeLine(connection, "Group 3 break", idAnimalA, minFrame=tmin,
                                                                  maxFrame=tmax)
            ...
            for event in group3Dictionary[idAnimalA].eventList:
                ...
                for idAnimalB in animalWTDictionary.keys():
                    for idAnimalC in animalWTDictionary.keys():
                        if (animalMakeGroupDictionary[idAnimalB].hasEvent(frameToCkeckMake) and
                                animalBreakGroupDictionary[idAnimalC].hasEvent(frameToCkeckBreak)):
        ...
        text_file.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(file, "Group 3 WKK",
                                                                                          "WT make & WT break Group3",
                                                                                          wtMakeWtBreakGroup3WKK.getNbEvent(),
                                                                                          wtMakeWtBreakGroup3WKK.getMeanEventLength(),
                                                                                          "WT make & KO break group3",
                                                                                          wtMakeKoBreakGroup3WKK.getNbEvent(),
                                                                                          wtMakeKoBreakGroup3WKK.getMeanEventLength(),
                                                                                          "KO make & WT break group3",
                                                                                          koMakeWtBreakGroup3WKK.getNbEvent(),
                                                                                          koMakeWtBreakGroup3WKK.getMeanEventLength(),
                                                                                          "KO make & KO break group3",
                                                                                          koMakeKoBreakGroup3WKK.getNbEvent(),
                                                                                          koMakeKoBreakGroup3WKK.getMeanEventLength()))
        ...
        text_file.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(file, "Group 3 WWK",
                                                                                          "WT make & WT break Group3",
                                                                                          wtMakeWtBreakGroup3WWK.getNbEvent(),
                                                                                          wtMakeWtBreakGroup3WWK.getMeanEventLength(),
                                                                                          "WT make & KO break group3",
                                                                                          wtMakeKoBreakGroup3WWK.getNbEvent(),
                                                                                          wtMakeKoBreakGroup3WWK.getMeanEventLength(),
                                                                                          "KO make & WT break group3",
                                                                                          koMakeWtBreakGroup3WWK.getNbEvent(),
                                                                                          koMakeWtBreakGroup3WWK.getMeanEventLength(),
                                                                                          "KO make & KO break group3",
                                                                                          koMakeKoBreakGroup3WWK.getNbEvent(),
                                                                                          koMakeKoBreakGroup3WWK.getMeanEventLength()))
