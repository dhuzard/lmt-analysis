...
import BuildEventCenterPeriphNWNESWSE
...
eventClassList = [BuildEventCenterPeriphNWNESWSE]
...
def process(file):
    ...
    try:
        ...
        while currentT < maxT:
            ...
            chronoTimeWindowFile = Chronometer("File " + file
                                               + " currentMinT: " + str(currentMinT)
                                               + " currentMaxT: " + str(currentMaxT))
...
if __name__ == '__main__':
    ...
    if availableMemoryGB < 10:
        print("Not enough memory (<10Gb) to use cache load of events.")
